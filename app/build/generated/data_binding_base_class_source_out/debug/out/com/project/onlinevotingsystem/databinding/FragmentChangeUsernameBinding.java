...
public final class FragmentChangeUsernameBinding implements ViewBinding {
  ...
  private FragmentChangeUsernameBinding(@NonNull FrameLayout rootView, @NonNull ImageView imageView,
  ...
  public static FragmentChangeUsernameBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentChangeUsernameBinding((FrameLayout) rootView, imageView, password,
